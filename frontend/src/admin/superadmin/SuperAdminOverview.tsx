  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <Link 
          to="/admin/users"
          className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group block"
        >
          <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center text-blue-600 mb-5 group-hover:scale-110 transition-transform">
        ...
        <Link 
          ...
          className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group block"
        >
          <div className="w-10 h-10 rounded-lg bg-purple-50 flex items-center justify-center text-purple-600 mb-5 group-hover:scale-110 transition-transform">
        ...
        <Link 
          ...
          className="bg-white rounded-xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group block"
        >
          <div className="w-10 h-10 rounded-lg bg-red-50 flex items-center justify-center text-red-600 mb-5 group-hover:scale-110 transition-transform">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <div 
          onClick={() => navigate('/executive/ceo?mode=view')}
          className="md:col-span-4 cursor-pointer group relative overflow-hidden bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between min-h-[320px]"
        >
          <div className="absolute top-0 right-0 -mt-8 -mr-8 w-48 h-48 bg-primary/5 rounded-full blur-3xl group-hover:bg-primary/20 transition-colors"></div>
          <div>
          ...
          <div className="flex items-center justify-between mt-8 relative z-10">
            ...
            <button className="bg-primary text-white px-5 py-2 rounded-full text-sm font-semibold flex items-center gap-2 hover:bg-primary-container transition-colors active:scale-95 shadow-lg shadow-primary/20">
              Launch Portal
        ...
        <div 
          onClick={() => navigate('/executive/coo?mode=view')}
          className="md:col-span-2 cursor-pointer group bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
        >
          ...
          <h3 className="text-xl font-headline font-bold text-on-surface mb-3">COO Dashboard</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed mb-8 flex-1">Monitor operational efficiency, supply chain integrity, and internal process health across all regions.</p>
          <button className="w-full py-3 rounded-xl border border-outline-variant/30 text-secondary font-semibold hover:bg-secondary-container/20 group-hover:bg-secondary-container/10 transition-colors">
            Enter Workspace
          </button>
        </div>
        ...
        {/* CFO Dashboard */}
        <div 
          onClick={() => navigate('/executive/cfo?mode=view')}
          className="md:col-span-2 cursor-pointer group bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
        >
          ...
          <h3 className="text-xl font-headline font-bold text-on-surface mb-3">CFO Dashboard</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">Real-time fiscal monitoring, burn rates, and quarterly projections with automated auditing.</p>
        </div>

        {/* CTO Dashboard */}
        <div 
          onClick={() => navigate('/executive/cto?mode=view')}
          className="md:col-span-2 cursor-pointer group bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
        >
          <div className="w-12 h-12 bg-primary-container/10 rounded-xl flex items-center justify-center text-primary-container mb-6 group-hover:scale-110 transition-transform">
            <span className="material-symbols-outlined text-2xl" data-icon="terminal">terminal</span>
          </div>
          <h3 className="text-xl font-headline font-bold text-on-surface mb-3">CTO Dashboard</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">Infrastructure uptime, technical debt indicators, and ongoing engineering velocity tracking.</p>
        </div>

        {/* Manager Hub */}
        <div 
          onClick={() => navigate('/dashboard?mode=view')}
          className="md:col-span-2 cursor-pointer group bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
        >
          ...
          <h3 className="text-xl font-headline font-bold text-on-surface mb-3">Manager Hub</h3>
          <p className="text-sm text-on-surface-variant leading-relaxed">Personnel performance metrics, department-level OKRs, and localized team management tools.</p>
        </div>

      </div>

      {/* Footer Stats Overlay */}
      <div className="mt-12 flex flex-wrap gap-8 items-center justify-between p-8 bg-surface-container-low rounded-xl border border-outline-variant/10">
        ...
        <div className="flex items-center gap-2 text-primary font-semibold text-sm cursor-pointer hover:underline">
          View Network Health
