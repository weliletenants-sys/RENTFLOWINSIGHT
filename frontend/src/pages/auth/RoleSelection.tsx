...
export default function RoleSelection() {
  ...
  return (
    <div className="font-sans antialiased min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#6d28d9] via-[#7c3aed] to-[#5b21b6] relative">
      <style>{`
      ...
      <main className="relative z-10 w-full max-w-6xl bg-[#f4edfc] rounded-3xl shadow-2xl overflow-hidden p-8 md:p-16 opacity-0 animate-fade-in-up">
