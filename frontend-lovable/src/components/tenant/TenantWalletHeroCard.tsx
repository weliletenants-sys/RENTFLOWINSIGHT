        ...
        <div className="relative z-10 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="portfolio-stat-cell-v2 rounded-xl px-2 py-3 text-center overflow-hidden">
              ...
              <p className="text-sm font-black leading-none text-white truncate" title={formatAmount(rentDue)}>
                {formatAmountCompact(rentDue)}
              </p>
              <p className="text-[8px] uppercase tracking-[0.14em] font-bold text-white/50 mt-1.5">Rent Due</p>
            </div>
            ...
            <div className="portfolio-stat-cell-v2 rounded-xl px-1.5 py-3 text-center">
              ...
              <p className="text-xl font-black leading-none text-white">{daysUntilDue}</p>
              <p className="text-[8px] uppercase tracking-[0.14em] font-bold text-white/50 mt-1.5">Days Left</p>
            </div>
            ...
            >
              ...
              <p className={`text-lg font-black leading-none ${coverage >= 100 ? 'text-emerald-300' : coverage >= 50 ? 'text-amber-300' : 'text-white'}`}>
                {coverage}%
              </p>
