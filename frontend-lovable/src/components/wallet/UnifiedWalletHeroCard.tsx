    ...
    <div className="w-full text-left portfolio-hero-card rounded-3xl p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 space-y-4">
        ...
        {role === 'supporter' && (
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="bg-white/10 backdrop-blur-sm rounded-xl p-2.5 text-center active:scale-[0.95] transition-transform"
            >
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <button
            onClick={handleOpenWallet}
            className="flex items-center gap-0.5 text-white/40 active:text-white/60 transition-colors"
          >
