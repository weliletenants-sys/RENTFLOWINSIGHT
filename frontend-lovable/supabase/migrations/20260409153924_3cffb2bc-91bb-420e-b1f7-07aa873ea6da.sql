...
DECLARE
  ...
  locked_categories TEXT[] := ARRAY[
    'wallet_deposit','wallet_withdrawal','rent_disbursement','rent_receivable_created',
    ...
    'agent_repayment','agent_float_used_for_rent',
    'partner_funding','wallet_transfer','system_balance_correction',
...
BEGIN
  ...
  -- PASS 2: Insert with bypass flag
