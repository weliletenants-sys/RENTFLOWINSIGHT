-- Fix the notify_onboarding_milestone function where target_count variable conflicts with column name
...
BEGIN
  ...
  -- Get the monthly target (renamed variable to v_target_count to avoid ambiguity)
