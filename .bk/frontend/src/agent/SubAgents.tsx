      ...
      <main className="flex-1 overflow-y-auto pb-24">
        <div className="p-4 flex flex-col gap-6">
          <div className="w-full">
            <button 
              onClick={() => navigate('/register-sub-agent')}
              className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl h-14 bg-primary text-white font-bold text-lg shadow-lg shadow-primary/20 hover:opacity-90 active:scale-[0.98] transition-all"
            >
              <UserPlus size={24} />
