...
import { getDashboardStats, getPortfolios, getPortfolioDetails, getRecentActivities, fundRentPool, requestWithdrawal, getOpportunities, updateProfileInfo, topupRentPool } from '../../controllers/funder.controller';
